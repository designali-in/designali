  ...
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path d="M8,2.5l1.88,1.88" />
        <path d="M14.12,4.38l1.88-1.88" />
        ...
        <path d="M12,20.5v-9" />
        <path d="M6.53,9.5c-1.93-.2-3.53-1.9-3.53-4" />
        <path d="M6,13.5H2" />
        <path d="M3,21.5c0-2.1,1.7-3.9,3.8-4" />
        <path d="M20.97,5.5c0,2.1-1.6,3.8-3.5,4" />
        <path d="M22,13.5h-4" />
        <path d="M17.2,17.5c2.1.1,3.8,1.9,3.8,4" />
      </svg>
    );
  },
);
