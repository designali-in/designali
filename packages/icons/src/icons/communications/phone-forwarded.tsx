...
export const PhoneForwarded = React.forwardRef<SVGSVGElement, DesignaliProps>(
  ({  ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <polyline  points="17.94 2.04 21.94 6.04 17.94 10.04"/>
  <line  x1="13.94" y1="6.04" x2="21.94" y2="6.04"/>
