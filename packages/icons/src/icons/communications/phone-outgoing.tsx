...
export const PhoneOutgoing = React.forwardRef<SVGSVGElement, DesignaliProps>(
  ({  ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
       <polyline  points="21.94 8.04 21.94 2.04 15.94 2.04"/>
  <line  x1="15.94" y1="8.04" x2="21.94" y2="2.04"/>
