  ...
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path d="M18.83,18.83c-1.17,1.17-3.06,1.17-6.83,1.17s-5.66,0-6.83-1.17c-1.17-1.17-1.17-3.06-1.17-6.83s0-5.66,1.17-6.83c1.17-1.17,3.06-1.17,6.83-1.17s5.66,0,6.83,1.17c1.17,1.17,1.17,3.06,1.17,6.83s0,5.66-1.17,6.83Z" />
