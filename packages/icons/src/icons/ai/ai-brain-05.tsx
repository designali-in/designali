  ...
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path d="M7.5,4.5c-1.66,0-3,1.34-3,3,0,.57.16,1.1.43,1.55-1.39.27-2.43,1.48-2.43,2.95s1.05,2.68,2.43,2.95M7.5,4.5c0-1.38,1.12-2.5,2.5-2.5s2.5,1.12,2.5,2.5v1.5M7.5,4.5c0,.82.39,1.54,1,2M4.93,14.95c-.27.45-.43.98-.43,1.55,0,1.66,1.34,3,3,3,0,1.38,1.12,2.5,2.5,2.5s2.5-1.12,2.5-2.5v-1.5M4.93,14.95c.36-.59.91-1.04,1.57-1.28" />
