...
Contains a set of `ToggleGroup.Item` components. Extends the
<a href="https://www.radix-ui.com/primitives/docs/components/toggle-group" rel="nofollow noreferrer" target="_blank">Radix
Toggle Group</a> primitive and includes all of its props. Alternatively,
`ToggleGroup.Root` can be used in place of this component.
