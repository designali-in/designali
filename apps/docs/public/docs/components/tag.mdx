...
`Tag` component supports all props of the `Badge` component. In addition to
that, it also supports the following props.
...
<PropsTable
  content={[
    ...
    [
      ...
      {
        value: "ReactElement<typeof Avatar>",
        description: "Expects Avatar component.",
      },
      {},
    ],
