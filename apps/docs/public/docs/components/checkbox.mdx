...
title: Checkbox
description:
  A user interface control enabling toggling between checked and unchecked
  states.
links:
...
For more advanced usage you can use `Checkbox.Root` component to customize the
...
<a href="https://www.radix-ui.com/docs/primitives/components/checkbox" target="_blank" rel='nofollow noreferrer'>Radix
Checkbox</a> primitive and supports all of its props.
...
The `Checkbox` component supports all accessibility features of the
<a href="https://www.radix-ui.com/primitives/docs/components/checkbox#accessibility" target="_blank" rel='nofollow noreferrer'>Radix
Checkbox</a> primitive.
