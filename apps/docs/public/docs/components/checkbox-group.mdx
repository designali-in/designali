...
description:
  A visual group of Checkbox controls, allowing for the selection of multiple
  options within a set.
links:
...
Alternatively, `CheckboxGroup.Root` can be used in place of this component.
Besides all props from `HTMLAttributes<HTMLDivElement>`, `CheckboxGroup` also
includes these additional props:
...
Shares all the properties of the `Checkbox` component. Details can be found
[here](/components/checkbox#api-reference).
