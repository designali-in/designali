...
Extends the
<a href="https://www.radix-ui.com/primitives/docs/components/switch" rel="nofollow noreferrer" target="_blank">Radix
Switch</a> primitive and includes all of its props.
...
The `Switch` component supports all accessibility features of the
