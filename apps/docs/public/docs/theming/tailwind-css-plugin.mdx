...
Wedges provides a Tailwind CSS plugin enabling the use of Wedges design tokens
and creation of custom themes in your projects. This plugin is inspired and
based on the awesome
<a href="https://github.com/L-Blondy/tw-colors" target="_blank" rel="nofollow noreferrer">tw-colors</a>
plugin.

Tailwind CSS supports dark mode, but with Wedges, you can create an unlimited
number of custom themes. There's no cap on the themes and colors you can use,
and it even supports nested themes for more complex use cases.

### Installation

If you haven't installed Tailwind CSS already, follow the instructions in the
...
The `wedgesTW` plugin accepts a configuration object allowing you to customize
the plugin's behavior. This is the default structure of the configuration
object:
  ...
  content={[
    ...
    [
      { value: "defaultTheme", description: "The default theme to use." },
      {
        ...
        description:
          "Any key of a theme defined in the `wedgesTW` plugin or `light` or `dark`.",
      },
      { value: '"light"' },
    ],
    [
...
Wedges supports nested themes, enabling the use of multiple themes within
individual sections for flexible styling.
