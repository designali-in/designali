import type { ThemableColorScale } from "@designali/ui/src/tw-plugin/foundation/colors/themableColors";
import type { Config } from "tailwindcss";
import { wedgesPalette, wedgesTW } from "@designali/ui";
...
const config: Config = {
  content: [
    ...
    "node_modules/@designali/ui/dist/**/*.{js,ts,jsx,tsx}",
  ],
  darkMode: "class",
  theme: {
    extend: {
