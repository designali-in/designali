...
export const Demos: Record<string, Demo> = {
  "alert/example-1": {
    ...
    code: `import { Alert, Button } from "@designali/ui";
    ...
    <div className="flex flex-col gap-6">
      ...
      <Alert
        ...
        after={
          <Button
            variant="link"
            className="hover:text-surface-900 dark:text-wg-yellow-500 text-inherit dark:hover:text-yellow-300"
          >
            Upgrade
          </Button>
        }
...
`,
  ...
  "avatar/example-1": {
    ...
    code: `import { Avatar } from "@designali/ui";
...
`,
  ...
  "avatar/example-3": {
    ...
    code: `import { Avatar, Tooltip } from "@designali/ui";
...
`,
  ...
  "avatar-group/example-1": {
    ...
    code: `import { AvatarGroup } from "@designali/ui";
...
export function Example() {
  return (
    <div className="wg-bg-orange-100 dark:wg-bg-yellow-950 mx-auto max-w-fit rounded-lg p-12">
      <AvatarGroup
        size="xl"
        items={[
          {
...
import { Avatar, Badge } from "@designali/ui";
import {
  BookmarkIcon,
  CheckIcon,
  CloseIcon,
  ...
  return (
    <div className="mx-auto flex max-w-fit flex-col items-start gap-4">
      ...
      <div className="flex flex-wrap items-center justify-start gap-4">
        ...
        <Badge
          before={<DotIcon className="text-wg-green" />}
          shape="pill"
          stroke
        >
          Online
...
`,
  ...
  "badge/preview": {
    ...
    code: `import { Badge } from "@designali/ui";
...
`,
  ...
  "button/example-1": {
    ...
    code: `import { Button } from "@designali/ui";
import { PlusIcon } from "@iconicicons/react";
...
`,
  ...
  "button-group/example-1": {
    ...
    code: `import { ButtonGroup } from "@designali/ui";
import {
  ChevronDownIcon,
  DotsVerticalIcon,
  GridIcon,
...
`,
  ...
  "button-group/example-2": {
    ...
    code: `import { ButtonGroup, Tooltip } from "@designali/ui";
import {
  ChevronDownIcon,
  CopyIcon,
  DownloadIcon,
...
`,
  ...
  "checkbox/example-1": {
    ...
    code: `import { Checkbox } from "@designali/ui";
...
`,
  ...
  "checkbox/example-2": {
    ...
    code: `import { AvatarGroup, Checkbox } from "@designali/ui";
...
export function Example() {
  return (
    <div className="m-auto flex w-fit flex-col gap-6 text-left">
      <Checkbox.Root
        asChild
        className="border-surface-100 shadow-wg-xs wg-bg-white dark:wg-bg-neutral-900 flex w-80 cursor-pointer items-center justify-between rounded-lg border px-4 py-3 outline-2 -outline-offset-1 outline-primary [&:has([data-state=checked])]:outline"
      >
        <label>
          <Checkbox.Item />
...
`,
  ...
  "checkbox-group/example-1": {
    ...
    code: `import { CheckboxGroup } from "@designali/ui";
...
`,
  ...
  "dropdown-menu/example-1": {
    ...
    code: `import { Button, DropdownMenu } from "@designali/ui";
      ...
      <DropdownMenu.Content align="end" side="top">
        <DropdownMenu.Group>
          ...
          <DropdownMenu.Item>
            ...
            <DropdownMenu.Shortcut keys={["command", "option"]}>
              X
        ...
        <DropdownMenu.Group>
          <DropdownMenu.Item>
            ...
            <DropdownMenu.Shortcut keys={["shift", "command"]}>
              8
            </DropdownMenu.Shortcut>
          </DropdownMenu.Item>
...
import { Avatar, DropdownMenu, Switch } from "@designali/ui";
import {
  BellIcon,
  BookIcon,
  ChevronDownIcon,
...
export function Example() {
  ...
  return (
    <div className="flex items-center justify-center">
      <DropdownMenu>
        <DropdownMenu.Trigger asChild>
          <span className="text-surface-600 wg-antialiased hover:bg-surface group flex shrink cursor-pointer select-none items-center justify-center gap-1 rounded-lg p-1.5 px-2 text-sm transition-colors duration-100 dark:hover:bg-white/5">
            <Avatar
              size="xs"
              src="https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=250&h=250&auto=format&fit=crop&crop=face"
              status="green"
...
`,
  ...
  "input/preview": {
    ...
    code: `import { Input } from "@designali/ui";
...
`,
  ...
  "kbd/example-1": {
    ...
    code: `import { Kbd } from "@designali/ui";
...
`,
  ...
  "label/example-1": {
    ...
    code: `import { Label } from "@designali/ui";
...
`,
  ...
  "loading/example-1": {
    ...
    code: `import { Loading } from "@designali/ui";
...
`,
  ...
  "popover/example-1": {
    ...
    code: `import * as React from "react";
import { ButtonGroup, CheckboxGroup, Popover } from "@designali/ui";
...
`,
  ...
  "popover/preview": {
    ...
    code: `import { Button, CheckboxGroup, Popover } from "@designali/ui";
...
`,
  ...
  "progress-bar/example-1": {
    ...
    code: `import { ProgressBar } from "@designali/ui";
  ...
  return (
    <div className="inline-flex w-full max-w-[400px] flex-col gap-y-12">
      ...
      <ProgressBar
        ...
        color="red"
        helperText={
          <span className="text-destructive">Oops, something went wrong</span>
        }
...
`,
  ...
  "progress-circle/example-1": {
    ...
    code: `import { ProgressCircle } from "@designali/ui";
...
`,
  ...
  "progress-circle/preview": {
    ...
    code: `import * as React from "react";
import { ProgressCircle } from "@designali/ui";
...
export function Example() {
  ...
  return (
    <div className="inline-block">
      <ProgressCircle
        color={value < 33 ? "red" : value < 66 ? "orange" : "green"}
        value={value}
      />
    </div>
  );
...
`,
  ...
  "radio-group/example-1": {
    ...
    code: `import { RadioGroup } from "@designali/ui";
            ...
            <SelectGroup>
              <SelectItem value="pending">
                <div className="flex items-center gap-1">
                  <DotIcon className="text-wg-red -ms-1 size-6" />
                  <span>Pending</span>
                </div>
              </SelectItem>
              ...
              <SelectItem value="in-progress">
                <div className="flex items-center gap-1">
                  <DotIcon className="text-wg-yellow -ms-1 size-6" />
              ...
              <SelectItem value="in-review">
                <div className="flex items-center gap-1">
                  <DotIcon className="text-wg-blue -ms-1 size-6" />
                  <span>In Review</span>
                </div>
              </SelectItem>
              ...
              <SelectItem value="complete">
                <div className="flex items-center gap-1">
                  <DotIcon className="text-wg-green -ms-1 size-6" />
                  <span>Complete</span>
                </div>
              </SelectItem>
              ...
              <SelectItem value="archived">
                <div className="flex items-center gap-1">
                  <DotIcon className="text-wg-gray-300 -ms-1 size-6" />
                  <span>Archived</span>
                </div>
              </SelectItem>
            </SelectGroup>
...
`,
  ...
  "slider/example-1": {
    ...
    code: `import { Slider } from "@designali/ui";
...
import { useState } from "react";
import { Button, Slider } from "@designali/ui";
...
`,
  ...
  "switch/example-1": {
    ...
    code: `import { Switch } from "@designali/ui";
...
`,
  ...
  "switch-group/example-1": {
    ...
    code: `import { SwitchGroup } from "@designali/ui";
...
`,
  ...
  "tabs/example-1": {
    ...
    code: `import { Badge, Tabs } from "@designali/ui";
...
`,
  ...
  "tabs/example-2": {
    ...
    code: `import { Badge, Tabs, Tooltip } from "@designali/ui";
...
`,
  ...
  "tabs/example-3": {
    ...
    code: `import * as React from "react";
import { Badge, Tabs } from "@designali/ui";
...
`,
  ...
  "tabs/preview": {
    ...
    code: `import { Tabs } from "@designali/ui";
...
`,
  ...
  "tag/example-1": {
    ...
    code: `import * as React from "react";
import { Avatar, Tag } from "@designali/ui";
    ...
    <div className="mx-auto flex max-w-fit flex-col items-start gap-4">
      ...
      <div className="flex flex-wrap items-center justify-start gap-4">
        <Tag
          ...
          className="uppercase"
          closeIcon={
            <TrashIcon className="text-wg-orange-600 dark:text-wg-orange h-4 w-4" />
          }
          color="orange"
          shape="pill"
          size="sm"
...
/* ---------------------------------- Icons --------------------------------- */
const USFlagIcon = React.forwardRef<
  SVGSVGElement,
  React.SVGAttributes<SVGSVGElement>
>((props, ref) => {
  return (
...
const UKFlagIcon = React.forwardRef<
  SVGSVGElement,
  React.SVGAttributes<SVGSVGElement>
>((props, ref) => {
  return (
...
`,
  ...
  "tag/preview": {
    ...
    code: `import { Tag } from "@designali/ui";
...
`,
  ...
  "textarea/example-1": {
    ...
    code: `import { Textarea } from "@designali/ui";
...
`,
  ...
  "theming/dark-mode": {
    ...
    code: `import * as React from "react";
import { Button, Switch, Toggle, ToggleGroup, Tooltip } from "@designali/ui";
...
`,
  ...
  "toggle/preview": {
    ...
    code: `import { Toggle } from "@designali/ui";
...
`,
  ...
  "toggle-group/example-1": {
    ...
    code: `import { ToggleGroup } from "@designali/ui";
import {
...
`,
  ...
  "tooltip/example-1": {
    ...
    code: `import { Tooltip } from "@designali/ui";
...
`,
  ...
  "tooltip/example-2": {
    ...
    code: `import * as React from "react";
import { Tooltip } from "@designali/ui";
