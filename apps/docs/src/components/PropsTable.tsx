import type { LabelDocsParams } from "@/lib/docUtils";
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="border-surface-100 shadow-wg-xs my-[2em] overflow-x-auto rounded-lg border"
      >
                    ...
                    >
                      <div className="flex items-center gap-0.5">
                        ...
                        rowItem?.value?.includes("Present") ? (
                          ...
                          <code className="not-prose bg-surface-100/70 text-surface-800 relative break-words rounded px-[0.3rem] py-[0.15rem] font-mono text-[13px] text-xs [&:has(div)]:bg-transparent [&>div]:flex [&>div]:flex-col">
                            {rowItem.value}
                          </code>
                        ) : (
                          // Fallback if there's no value
                          <span className="text-surface-200 select-none">
                            /
                          </span>
                        )}
