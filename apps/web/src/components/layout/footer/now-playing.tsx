...
const NowPlaying = () => {
  ...
  return (
    <div className="hidden items-center justify-center gap-2 text-center">
      ...
      <div className="inline-flex w-full items-center justify-center gap-1 text-center text-sm md:justify-start">
