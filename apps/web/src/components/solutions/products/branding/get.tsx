  ...
  },
  {
    ...
    background: (
      <div className="grid items-center justify-center">
        <div className="">
          <h1 className="text-md text-center text-ali md:text-xl">
            Brand
            <br />
            Guideline
          </h1>
  ...
  },
  {
    ...
    background: (
      <div className="grid items-center justify-center gap-4 text-center">
        <div className="">
          <h1 className="text-md text-ali md:text-xl">Format</h1>
          <div className="flex h-5 flex-wrap items-center justify-center gap-4 font-mono text-xs">
      ...
      <div className="grid items-center gap-4">
        <div className="grid gap-8">
          {tiers.map((tier) => (
            <div
              key={tier.id}
              className="z-10 flex h-[400px] flex-col items-center justify-between rounded-2xl border bg-white p-8 shadow-xl dark:bg-black dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset] sm:p-10"
            >
              {" "}
