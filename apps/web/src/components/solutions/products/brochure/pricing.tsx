...
const tiers = [
  {
    name: "Start",
    id: "tier-hobby",
    heading: "Launch with impact: Essential web solution",
    ...
    features: [
      ...
      "3 resize options",
      "Source file",
      "Unlimited revisions for next 24 hours",
  ...
  },
  {
    name: "Grow",
    id: "tier-team",
    heading: "Growth-focused web solutions for expanding businesses",
    href: "https://cal.com/aliimam/designali",
    priceMonthly: "₹10,000",
    ...
    features: [
      ...
      "Source file",
      "Unlimited revisions for next 48 hours",
      "Unlimited stock photos & vector",
    ],
  },
  {
    name: "Bloom",
    id: "tier-team",
    heading: "A complete web package for businesses aiming for the top",
    href: "https://cal.com/aliimam/designali",
    priceMonthly: "₹20,000",
    description: "1 week delivery",
    features: [
      "9 Post Design",
      "3 Carousel Post",
      "Cover Banners",
...
export function BrochuresPricing() {
  return (
