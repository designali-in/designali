      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className=" px-4 py-3 bg-gray-50 lg:px-8">
          ...
          <div className="flex lg:flex-1 ">
            ...
            <DIcons.Apple aria-hidden="true" className="size-5 text-gray-500" />
            </a>
          </div>
          <div className="flex lg:hidden">
            ...
            >
              ...
              <DIcons.Equal aria-hidden="true" strokeWidth={1} className="size-5" />
            </button>
          </div>
          <div className="hidden lg:flex lg:gap-x-10">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-xs text-gray-900">
                {item.name}
              </a>
            ))}
          </div>
          <div className="hidden gap-6 lg:flex lg:flex-1 lg:justify-end">
            ...
            <DIcons.Search aria-hidden="true" strokeWidth={1} className="size-4" />
            </a>
            <a href="#" className="text-sm/6 font-semibold text-gray-900">
            <ShoppingBag aria-hidden="true" strokeWidth={1} className="size-4" />
            </a>
          </div>
          </div>
        </nav>
