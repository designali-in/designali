...
import { FileImage, FileText, Image, Link } from "lucide-react";
  ...
  return (
    <div className="flex items-center ">
      ...
      <div
        ...
        className="m-2 flex w-[25%] cursor-pointer flex-col justify-center rounded-xl  p-5 text-center text-sm"
      >
        <Link className="mx-auto mb-5  mt-[10px] w-[32px]" />

        <p className="font-medium uppercase">url</p>
      </div>
      ...
      <div
        ...
        className="m-2 flex  w-[25%] cursor-pointer  flex-col justify-center rounded-xl  p-5 text-center text-sm"
      >
        <FileText className="mx-auto mb-5 mt-[10px] w-[32px]" />

        <p className="font-medium uppercase">PDF</p>
      </div>
      {/* image */}
      <div
        ...
        className="m-2 flex  w-[25%] cursor-pointer  flex-col justify-center rounded-xl  p-5 text-center text-sm"
      >
        <FileImage className="mx-auto mb-5 mt-[10px] w-[32px]" />

        <p className="font-medium uppercase">Image</p>
      </div>
      ...
      <div
        ...
        className="m-2 flex  w-[25%] cursor-pointer  flex-col justify-center rounded-xl  p-5 text-center text-sm"
      >
        <div className="mx-auto mb-5 mt-[10px] w-[32px]">
          <svg
            stroke="currentColor"
            stroke-width="0.2"
            viewBox="0 0 16 16"
        ...
        <p className="font-medium uppercase">SVG</p>
      </div>
    </div>
  );
}
