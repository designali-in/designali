...
import { MaterialControlsProps } from "@/types/d3d";
        ...
        <>
          <div className="space-y-2">
            ...
            <Slider
              ...
              step={0.01}
              value={[roughness]}
              onValueChange={(value) => setRoughness(value[0] ?? 0)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              step={0.01}
              value={[metalness]}
              onValueChange={(value) => setMetalness(value[0] ?? 0)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              step={0.01}
              value={[clearcoat]}
              onValueChange={(value) => setClearcoat(value[0] ?? 0)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              step={0.01}
              value={[transmission]}
              onValueChange={(value) => setTransmission(value[0] ?? 0)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={(value) => setEnvMapIntensity(value[0] ?? 0)}
            />
          </div>
        </>
      )}
