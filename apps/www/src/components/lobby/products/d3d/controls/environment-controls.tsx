...
import { EnvironmentControlsProps } from "@/types/d3d";
          ...
          <div className="w-full">
            {environmentPreset === "custom" && customHdriUrl ? (
              ...
              <Button
                ...
                <DIcons.ArrowLeft className="w-4 h-4 ml-2"/>
              </Button>
            )}
          </div>
            ...
            <motion.div
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={(value) => setBloomIntensity(value[0] ?? 0)}
                  className="py-1"
                />
              </div>
              ...
              <div className="space-y-2 pt-3 border-t border-primary/10">
                ...
                <Slider
                  ...
                  onValueChange={(value) => setModelRotationY(value[0] ?? 0)}
                  className="py-1"
                />
              </div>
            </motion.div>
