...
import { GeometryControlsProps } from "@/types/d3d";
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={0.5}
          value={[depth]}
          onValueChange={(value) => setDepth(value[0] ?? 0)}
        />
      </div>
        ...
        {autoRotate && (
          <div className="space-y-2 pt-2">
            ...
            <Slider
              ...
              onValueChange={(value) =>
                setAutoRotateSpeed(displayToActualRotation(value[0] ?? 0))
              }
            />
          </div>
        )}
