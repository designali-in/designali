...
import PatternGenerator from "@/components/lobby/products/tools/design-pattern";
  ...
  return (
    <div className="relative">
      <div className="absolute inset-0 -top-40 -z-10 overflow-hidden">
        <svg
          aria-hidden="true"
          className="dark:stroke-red stroke-red-500/20 absolute left-[max(50%,25rem)] top-0 h-[64rem] w-[128rem] -translate-x-1/2 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]"
        >
          <defs>
            <pattern
              x="50%"
