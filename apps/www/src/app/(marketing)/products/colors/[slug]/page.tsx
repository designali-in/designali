...
import { ExportDialog } from "@/comp/common/colors/export-dialog";
import Palette from "@/comp/common/colors/palettes";
  ...
  return (
    <div className="relative">
      <div className="my-40">
        ...
        <div className="mx-auto my-10 max-w-7xl px-6 xl:px-0">
